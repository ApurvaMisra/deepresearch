...
class BamlStreamClient:
    ...
    def Chat(
        ...
        state: List[types.Message],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[Optional[Union[partial_types.Search, partial_types.Think, partial_types.Reply]], Union[types.Search, types.Think, types.Reply]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[Optional[Union[partial_types.Search, partial_types.Think, partial_types.Reply]], Union[types.Search, types.Think, types.Reply]](
        raw,
    ...
    def Thinking(
      ...
      return baml_py.BamlSyncStream[partial_types.Message, types.Message](
        raw,
