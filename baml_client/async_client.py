...
class BamlAsyncClient:
    ...
    async def Chat(
        self,
        state: List[types.Message],
        baml_options: BamlCallOptions = {},
    ) -> Union[types.Search, types.Think, types.Reply]:
      ...
      return cast(Union[types.Search, types.Think, types.Reply], raw.cast_to(types, types, partial_types, False))
    ...
    async def Thinking(
      ...
      return cast(types.Message, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def Chat(
        ...
        state: List[types.Message],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[Optional[Union[partial_types.Search, partial_types.Think, partial_types.Reply]], Union[types.Search, types.Think, types.Reply]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[Optional[Union[partial_types.Search, partial_types.Think, partial_types.Reply]], Union[types.Search, types.Think, types.Reply]](
        raw,
        lambda x: cast(Optional[Union[partial_types.Search, partial_types.Think, partial_types.Reply]], x.cast_to(types, types, partial_types, True)),
        lambda x: cast(Union[types.Search, types.Think, types.Reply], x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
    ...
    def Thinking(
        ...
        query: str,context: List[types.Message],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.Message, types.Message]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.Message, types.Message](
        raw,
        lambda x: cast(partial_types.Message, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.Message, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
